...
export async function checkDuplicate(statement, organizationId) {
    try {
        ...
        for (const q of existing) {
            const sim = cosineSimilarity(embedding, q.embeddingVector);
...
export async function storeEmbedding(questionId, statement) {
    const embedding = simpleEmbed(statement);
