...
export async function runValidationPipeline(question, config) {
    const result = {
...
async function _validateDSA(question, config, result) {
    const testCases = question.testCases ?? [];
    const optimalSolution = question.optimalSolution ?? {};
    const bruteForceSolution = question.bruteForceSolution ?? {};
    const languages = question.languages ?? config.languages;
    // Inject edge cases
...
async function _validateConceptual(question, _config, result) {
