...
export default function AdminPage() {
  ...
  const [activeTab, setActiveTab] = useState<'users' | 'audit' | 'webhooks'>('users');
        ...
        <div style={{ display: 'flex', gap: 4, marginBottom: 24, background: 'var(--color-bg-card)', padding: 4, borderRadius: 10, border: '1px solid var(--color-border)', width: 'fit-content' }}>
          {tabs.map(tab => (
            <button
              ...
              style={activeTab !== tab.id ? { background: 'transparent', border: 'none', color: 'var(--color-text-muted)' } : {}}
        ...
        {activeTab === 'webhooks' && (
          <div className="card animate-fade-in animate-delay-3">
            ...
            <div className="form-group">
              ...
              <input className="form-input" type="url" placeholder="https://your-platform.com/webhooks/question-forge"
